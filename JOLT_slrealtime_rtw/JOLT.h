...
struct B_JOLT_T {
  ...
  real_T buffOut[10000];               /* '<S5>/MATLAB Function' */
  real_T sigPulse;                     /* '<S4>/MATLAB Function4' */
  real_T sigPulse_p;                   /* '<S3>/MATLAB Function4' */
...
struct DW_JOLT_T {
  ...
  real_T t0;                           /* '<S4>/MATLAB Function4' */
  real_T t0_b;                         /* '<S3>/MATLAB Function4' */
  ...
  int32_T sfEvent_m;                   /* '<S4>/MATLAB Function4' */
  int32_T sfEvent_k;                   /* '<S3>/MATLAB Function4' */
  ...
  uint8_T is_active_c3_JOLT;           /* '<S5>/MATLAB Function' */
  uint8_T is_active_c5_JOLT;           /* '<S4>/MATLAB Function4' */
  uint8_T is_active_c4_JOLT;           /* '<S3>/MATLAB Function4' */
  ...
  boolean_T doneDoubleBufferReInit_e;  /* '<S4>/MATLAB Function4' */
  boolean_T t0_not_empty;              /* '<S4>/MATLAB Function4' */
  boolean_T doneDoubleBufferReInit_f;  /* '<S3>/MATLAB Function4' */
  boolean_T t0_not_empty_p;            /* '<S3>/MATLAB Function4' */
 ...
 * '<S4>'   : 'JOLT/Subsystem1'
 * '<S5>'   : 'JOLT/Subsystem2'
 * '<S6>'   : 'JOLT/MUX/MATLAB Function'
 * '<S7>'   : 'JOLT/Subsystem/MATLAB Function4'
 * '<S8>'   : 'JOLT/Subsystem1/MATLAB Function4'
 * '<S9>'   : 'JOLT/Subsystem2/MATLAB Function'
 */
