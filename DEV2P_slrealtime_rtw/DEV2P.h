...
#ifndef RTW_HEADER_DEV2P_h_
#define RTW_HEADER_DEV2P_h_
#include <logsrv.h>
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "verify/verifyIntrf.h"
#include "DEV2P_types.h"
#include <stddef.h>
#include <cstring>
#include "DEV2P_cal.h"
...
struct B_DEV2P_T {
  ...
  real_T imAcq_outTst;                 /* '<Root>/imAcq_outTst' */
  ...
  real_T treadAcq_out;                 /* '<Root>/MATLAB Function' */
  real_T pupilAcq_out;                 /* '<Root>/MATLAB Function' */
...
struct DW_DEV2P_T {
  ...
  int32_T clockTickCounter;            /* '<Root>/Pupil Trig' */
  int32_T clockTickCounter_a;          /* '<Root>/imAcq_outTst' */
  int32_T sfEvent;                     /* '<S2>/MATLAB Function1' */
  int32_T sfEvent_e;                   /* '<Root>/MATLAB Function' */
  uint8_T is_active_c2_DEV2P;          /* '<S2>/MATLAB Function1' */
  uint8_T is_active_c1_DEV2P;          /* '<Root>/MATLAB Function' */
...
extern "C"
{
  ...
  extern struct B_DEV2P_T DEV2P_B;
...
extern struct DW_DEV2P_T DEV2P_DW;

/* External data declarations for dependent source files */
extern const real_T DEV2P_RGND;        /* real_T ground */
...
extern "C"
{
  ...
  extern void DEV2P_initialize(void);
  extern void DEV2P_step(void);
  extern void DEV2P_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_DEV2P_T *const DEV2P_M;
 ...
 *
 * '<Root>' : 'DEV2P'
 * '<S1>'   : 'DEV2P/MATLAB Function'
 * '<S2>'   : 'DEV2P/tonePulse'
 * '<S3>'   : 'DEV2P/tonePulse/MATLAB Function1'
 */
#endif                                 /* RTW_HEADER_DEV2P_h_ */
