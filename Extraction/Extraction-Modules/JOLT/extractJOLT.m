function expmntData_ext = extractJOLT(params, sessionsToExtract, Q)         
    ...
    for i = 1:length(sessions)
        ...
        isLFPExtract = extractionLog(contains(extractionLog.SessionName,session),:).Extracted_LFP;
        isSLRTExtract =  extractionLog(contains(extractionLog.SessionName,session),:).Extracted_SLRT;
        ...
        if ~isSLRTExtract
            ...
            numTrials = length(trialKeepOrDrop);
            ...
            for j=1:numTrials                
                ...
                if regexp(rtSession, 'spontaneous', 'match', 'once') == "spontaneous"
                    ...
                    expmntData_ext.SLRT.stimTrace_lowess_span10 = [expmntData_ext.SLRT.stimTrace_lowess_span10; nan];
                    expmntData_ext.SLRT.stimTrace_lowess_span2 = [expmntData_ext.SLRT.stimTrace_lowess_span2; nan];
