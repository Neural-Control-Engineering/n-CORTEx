...
#ifndef RTW_HEADER_nCORTEx_vt_h_
#define RTW_HEADER_nCORTEx_vt_h_
#include <logsrv.h>
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "verify/verifyIntrf.h"
#include "nCORTEx_vt_types.h"
#include <stddef.h>
#include <cstring>
...
struct DW_nCORTEx_vt_T {
  ...
  uint8_T is_active_c2_nCORTEx_vt;     /* '<S3>/MATLAB Function1' */
  uint8_T is_active_c1_nCORTEx_vt;     /* '<Root>/MATLAB Function' */
...
extern "C"
{
  ...
  extern struct B_nCORTEx_vt_T nCORTEx_vt_B;
...
extern struct DW_nCORTEx_vt_T nCORTEx_vt_DW;

/* External data declarations for dependent source files */
extern const real_T nCORTEx_vt_RGND;   /* real_T ground */
...
extern "C"
{
  ...
  extern void nCORTEx_vt_initialize(void);
  extern void nCORTEx_vt_step(void);
  extern void nCORTEx_vt_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_nCORTEx_vt_T *const nCORTEx_vt_M;
 ...
 *
 * '<Root>' : 'nCORTEx_vt'
 * '<S1>'   : 'nCORTEx_vt/MATLAB Function'
 * '<S2>'   : 'nCORTEx_vt/Session Timer'
 * '<S3>'   : 'nCORTEx_vt/tonePulse'
 * '<S4>'   : 'nCORTEx_vt/tonePulse/MATLAB Function1'
 */
#endif                                 /* RTW_HEADER_nCORTEx_vt_h_ */
