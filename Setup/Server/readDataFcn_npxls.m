    ...
    for i = 1:length(cmdBuffer)
        ...
        switch PVidx            
            ...
            case 10 % RT STREAM - VIS OBJECT
                ...
                rtDash.panel2.ph = uipanel(rtDash.fh,"Position",[520,10,500,580],"BackgroundColor",[0,0,0]);
                rtDash.panel2.Ax = axes("Parent",rtDash.panel2.ph);
                rtDash.panel2.imgAx = imagesc(rtDash.panel2.Ax,"CData",[]);                
                ...
                rtDash.panel1.ph = uipanel(rtDash.fh,"Position",[10,10,500,580],"BackgroundColor",[0,0,0]);
                rtDash.panel1.Ax = axes("Parent",rtDash.panel1.ph,"Color",[0,0,0]);
                rtDash.panel1.surfAx = surf(rtDash.panel1.Ax,"CData",[]);
                rtDash.panel1.surfAx.EdgeColor="none";                
                rtDash.panel1.Ax.ZLim=[-10,25];
