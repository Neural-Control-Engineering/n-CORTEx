#ifndef __ATTN_sfun_h__
#define __ATTN_sfun_h__
...
extern mxArray* load_ATTN_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_ATTN_optimization_info(void);
