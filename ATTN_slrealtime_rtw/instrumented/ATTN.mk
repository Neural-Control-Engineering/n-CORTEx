...
## 
## Makefile     : ATTN.mk
## Generated on : Wed Feb 07 16:33:45 2024
...
PRODUCT = $(START_DIR)/ATTN_slrealtime_rtw/ATTN
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ATTN_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I/home/electro/.speedgoat/speedgoatlib/R2023a/9.6.1.1_4/sg_blocks/common/libsg -I/home/electro/.speedgoat/speedgoatlib/R2023a/9.6.1.1_4 -I/home/electro/.speedgoat/speedgoatlib/R2023a/9.6.1.1_4/sg_blocks/analog/include -I$(START_DIR)/ATTN_slrealtime_rtw/instrumented
...
%.o : $(START_DIR)/ATTN_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/ATTN_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/ATTN_slrealtime_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/ATTN_slrealtime_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
ATTN.o : $(START_DIR)/ATTN_slrealtime_rtw/ATTN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


ATTN_cal.o : $(START_DIR)/ATTN_slrealtime_rtw/ATTN_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/ATTN_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/ATTN_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/ATTN_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
rte_ATTN_parameters.o : $(START_DIR)/ATTN_slrealtime_rtw/rte_ATTN_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/ATTN_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
sg_IO191_da_s.o : /home/electro/.speedgoat/speedgoatlib/R2023a/9.6.1.1_4/sg_blocks/analog/sg_IO191_da_s.c
	$(CC) $(CFLAGS) -o $@ $<
