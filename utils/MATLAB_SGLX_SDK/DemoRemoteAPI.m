...
% -----------------------------------------
%
function DemoRemoteAPI

% Create connection (edit the IP address)
hSGL = SpikeGL('128.59.150.93');
...
% subset = GetStreamSaveChans(hSGL, 2, 0);
% subset = subset(1:64);
...
%     IsSaving(hSGL)
%     a = GetStreamAcqChans(hSGL, 0, 0)
%     a = GetStreamSaveChans(hSGL, 0, 0)

% -----------------------
% Fetch data for graphing
% -----------------------

%     mat = FetchLatest(hSGL, 2, 0, 2000);
