function nexObj = nexFigure_spectroScope(nexObj)
    ...
    % opCfg entry bar    
    panel2.ph = uipanel(nexObj.Figure.panel0.ph,"Position",[1, 1, 125, 200],"BackgroundColor",[0,0,0],"Scrollable","on");
    ...
    %% CFG ENTRIES
    compCfgEntryChangedFcn = str2func("methodCfgEntryChanged");
    ...
    % fcn cfg panels
    nexObj.Figure.panel2 = nexObj_cfgPanel_spinner(nexon, nexObj, panel2, opArgs, opCfgEntryChangedFcn, []);
