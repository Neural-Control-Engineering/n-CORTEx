function routerCfgParams = initializeRouterCfg(DTS)
    ...
    % router.signal="lfp";            
    routerCfgParams.subject = parseSessionLabelUnique(DTS.sessionLabel,"subj");
    % subjSel = routerCfgParams.subject(1)
    subjSessionLabels = DTS.sessionLabel(contains(DTS.sessionLabel,routerCfgParams.subject(1)));
