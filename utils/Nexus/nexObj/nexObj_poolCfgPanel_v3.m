function poolCfgPanel = nexObj_poolCfgPanel_v3(nexObj, panel, poolCfgEntryChangedFcn)
    ...
    for i = 1:length(axFields)
        ...
        panel.(uiID) = uidropdown(panel.ph, ...
            ...
            "FontColor", [0, 0, 0],...
            "ValueChangedFcn", @(src, event)poolCfgEntryChangedFcn(src, event, poolMap, "binType", nexObj));
        ...
        panel.(uiID) = uispinner(panel.ph, ...
            ...
            "Limits", [-Inf, Inf], ...
            "Step", 1,...
            "ValueChangedFcn", @(src, event)poolCfgEntryChangedFcn(src, event, poolMap, "divsPerBin", nexObj));
        ...
        panel.(uiID) = uispinner(panel.ph, ...
            ...
            "Limits", [1, Inf], ...
            "Step", 1,...
            "ValueChangedFcn", @(src, event)poolCfgEntryChangedFcn(src, event, poolMap, "reducerDim", nexObj));
